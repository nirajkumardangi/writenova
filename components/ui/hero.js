    ...
    <div className="w-full h-full max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-5 items-center relative">
      ...
      <div className="col-span-1 lg:col-span-3 flex flex-col space-y-6 z-10 py-10 lg:py-0">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
          <button className="w-full sm:w-auto px-10 py-4 bg-neutral-900 text-white rounded-full font-medium hover:bg-black transition-all shadow-lg active:scale-95 cursor-pointer">
            Start Writing Free
          </button>
